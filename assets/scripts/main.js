(function () {
    ...
    function setupSpaceBackground(reduceMotion) {
        ...
        function drawGalaxy() {
            ...
            gradient.addColorStop(0, 'rgba(88, 255, 184, 0.3)');
            gradient.addColorStop(0.28, 'rgba(44, 186, 126, 0.14)');
            gradient.addColorStop(0.65, 'rgba(11, 60, 40, 0.05)');
        ...
        function drawStars() {
            ...
            for (var i = 0; i < stars.length; i += 1) {
                ...
                var alpha = 0.18 + star.depth * 0.52 * glow;
                ctx.beginPath();
